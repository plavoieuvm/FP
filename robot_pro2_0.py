...
class ROBOT:
    ...
    def send_objects(self, sim):
        ...
        self.body = sim.send_box(x=0, y=0, z=c.L + c.R+.018+.02, length=c.L, width=c.L, height=2 * c.R, r=0.5, g=0.5, b=0.5, collision_group='rob')

        self.leg1 = sim.send_cylinder(x=0, y=c.L, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=0, r2=1, r3=-1, r=1.0, g=0, b=0, collision_group='rob')
        self.leg2 = sim.send_cylinder(x=c.L, y=0, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=1, r2=0, r3=-1, r=0, g=1.0, b=0, collision_group='rob')
        self.leg3 = sim.send_cylinder(x=0, y=-c.L, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=0, r2=1, r3=1, r=0, g=0, b=1, collision_group='rob')
        self.leg4 = sim.send_cylinder(x=-c.L, y=0, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=1, r2=0, r3=1, r=1, g=0, b=1, collision_group='rob')


        #self.legT = sim.send_cylinder(x=0, y=-c.L/2, z=c.L + .018, length=0, radius=.02, r=1.0, g=0, b=0, collision_group='rob')

        self.leg5 = sim.send_cylinder(x=0, y=(2*c.L)-c.R, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=0, r2=1, r3=1, r=1.0, g=0, b=0, collision_group='rob')
        self.leg6 = sim.send_cylinder(x=(2*c.L)-c.R, y=0, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=1, r2=0, r3=1, r=0, g=1.0, b=0, collision_group='rob')
        self.leg7 = sim.send_cylinder(x=0, y=-(2*c.L)+c.R, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=0, r2=1, r3=-1, r=0, g=0, b=1, collision_group='rob')
        self.leg8 = sim.send_cylinder(x=-(2*c.L)+c.R, y=0, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=-1, r2=0, r3=1, r=1, g=0, b=1, collision_group='rob')

        self.leg9 = sim.send_cylinder(x=0, y=(3*c.L)-c.R*2, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=0, r2=1, r3=-1, r=1.0, g=0, b=0, collision_group='rob')
        self.leg10 = sim.send_cylinder(x=(3*c.L)-c.R*2, y=0, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=1, r2=0, r3=-1, r=0, g=1.0, b=0, collision_group='rob')
        self.leg11 = sim.send_cylinder(x=0, y=-(3*c.L)+c.R*2, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=0, r2=1, r3=1, r=0, g=0, b=1, collision_group='rob')
        self.leg12 = sim.send_cylinder(x=-(3*c.L)+c.R*2, y=0, z=(c.L + c.R)/2+.018+.02, length=c.L, radius=c.R, r1=1, r2=0, r3=1, r=1, g=0, b=1, collision_group='rob')
        ...
        self.O[14] = self.foot1
        self.O[15] = self.foot2
    ...
    def send_joints(self, sim):
        ...
        self.jointa4 = sim.send_hinge_joint(first_body_id=self.leg8, second_body_id=self.leg12, x=-(2*c.L)-c.R, y=0,
                                       z=c.L+.018+.02, n1=0, n2=1, n3=0, lo=-3.14159/2, hi=3.14159/2)
        #
        # self.foot1J = sim.send_fixed_joint(first_body_id=self.leg5, second_body_id=self.foot1)
        # self.foot2J = sim.send_fixed_joint(first_body_id=self.leg5, second_body_id=self.foot1)
    ...
    def send_sensors(self, sim):
        ...
        self.touch5 = sim.send_touch_sensor(body_id=self.foot1)
        self.touch6 = sim.send_touch_sensor(body_id=self.leg10)
        self.touch7 = sim.send_touch_sensor(body_id=self.leg11)
        self.touch8 = sim.send_touch_sensor(body_id=self.foot2)
